...
export const ConnectComponent = ({ platform }) => {
  return (
    <div className='connect-component'>
        <div className="setting-main-imgs">
            <div className='platform-image'>
                {
                    platform === 'xbox'
                      ? (
                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" className="bi bi-xbox" viewBox="0 0 16 16">
                      ...
                      : (
                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" className="bi bi-playstation" viewBox="0 0 16 16">
