...
export const SearchItem = ({ gameInfo }) => {
  const cleanInput = () => {
  ...
  return (
        <li className='search-item'>
            ...
            <div className="search-game-data">
                {
                    gameInfo.platform === 'xbox'
                      ? (
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-xbox" viewBox="0 0 16 16">
                      ...
                      : <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-playstation" viewBox="0 0 16 16">
